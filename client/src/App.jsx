...
import V62Pedidos from './V62Pedidos.jsx';

export default function AppV5(){
  return <><App/><V5Dashboard/><V5Clients/><V5Assets/><V54Reports/><V55Operational/><V56ClientRequests/><V6Units/><V61Clients/><V62Pedidos/></>;
}
